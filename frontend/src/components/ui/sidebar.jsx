...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-8 h-12 w-12 md:h-10 md:w-10 p-2", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
      {...props}>
      <PanelLeftIcon className="h-7 w-7 md:h-7 md:w-7 lg:h-8 lg:w-8" />
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      {...props}>
      {showIcon && (
        <Skeleton className="size-6 rounded-md" data-sidebar="menu-skeleton-icon" />
      )}
      <Skeleton
